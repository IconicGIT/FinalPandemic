...
UpdateResult ModuleFadeToBlack::Update()
{
	...
	if (currentStep == Fade_Step::TO_BLACK)
	{
		...
		{
			// L10: TODO 1: Enable / Disable the modules received when FadeToBlack() gets called
			
			

				if ((moduleToDisable->IsEnabled()))
				{
...
bool ModuleFadeToBlack::FadeToBlack(Module* moduleToDisable, Module* moduleToEnable, float frames)
{
	...
	if(currentStep == Fade_Step::NONE)
	{
		...
		// L10: TODO 1: Keep track of the modules received in FadeToBlack()
